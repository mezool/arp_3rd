...
int transfer(int sock) {
    ...
    // wait for data with a timeout
    if (wait_for_data(sock, TIMEOUT_SECONDS) == 0) {
        printf("No data for obstacle received within the specified timeout. Moving on...\n");
